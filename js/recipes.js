...
const REZEPTE = [
  ...
  {
    id: "halloumi-salat",
    name: "Halloumi-Salat mit Gemüse",
    meal: "mittag",
    tags: ["vegetarisch", "low-carb", "high-protein", "glutenfrei"],
    zeit: 18,
    kcal: 430, protein: 26, kh: 12, fett: 30,
    zutaten: [
      { name: "Halloumi", menge: 120, einheit: "g", cat: "Milchprodukte" },
      { name: "Blattsalat", menge: 100, einheit: "g", cat: "Obst & Gemuese" },
      { name: "Kirschtomaten", menge: 100, einheit: "g", cat: "Obst & Gemuese" },
      { name: "Gurke", menge: 0.5, einheit: "Stück", cat: "Obst & Gemuese" },
      { name: "Olivenöl", menge: 1, einheit: "EL", cat: "Vorrat" },
    ...
    schritte: [
      "Halloumi in Scheiben schneiden und in einer Pfanne goldbraun braten.",
      "Salat, Tomaten und Gurke in eine Schüssel geben.",
      "Mit Öl anmachen und den warmen Halloumi darauf anrichten.",
    ],
  },
  {
    id: "tofu-avocado-salat",
    name: "Tofu-Avocado-Salat (vegan)",
    meal: "mittag",
    tags: ["vegan", "vegetarisch", "low-carb", "high-protein", "glutenfrei", "laktosefrei"],
    zeit: 15,
    kcal: 440, protein: 24, kh: 14, fett: 30,
    zutaten: [
      { name: "Tofu natur", menge: 150, einheit: "g", cat: "Milchprodukte" },
      { name: "Avocado", menge: 0.5, einheit: "Stück", cat: "Obst & Gemuese" },
      { name: "Blattsalat", menge: 100, einheit: "g", cat: "Obst & Gemuese" },
    ...
    schritte: [
      "Tofu würfeln und in Öl knusprig braten, würzen.",
      "Salat, Tomaten und Avocado in eine Schüssel geben.",
      "Mit dem warmen Tofu und etwas Öl anrichten.",
    ],
  },
  {
    id: "tofu-brokkoli",
    name: "Gebratener Tofu mit Brokkoli (vegan)",
    meal: "abend",
    tags: ["vegan", "vegetarisch", "low-carb", "high-protein", "laktosefrei"],
    zeit: 22,
    kcal: 420, protein: 26, kh: 16, fett: 26,
    zutaten: [
      { name: "Tofu natur", menge: 150, einheit: "g", cat: "Milchprodukte" },
      { name: "Brokkoli", menge: 150, einheit: "g", cat: "Obst & Gemuese" },
      { name: "Sojasauce", menge: 2, einheit: "EL", cat: "Vorrat" },
    ...
    schritte: [
      "Tofu würfeln und in Sesamöl knusprig braten.",
      "Brokkoli und Knoblauch zugeben, 6–8 Min braten.",
      "Mit Sojasauce abschmecken.",
    ],
  },
  {
  ...
  // ========== WOCHE 1: 10 NEUE REZEPTE ==========
  {
    ...
    tags: ["vegetarisch", "high-protein", "glutenfrei"],
    zeit: 15,
    kcal: 390, protein: 30, kh: 40, fett: 10,
    zutaten: [
      { name: "Eier", menge: 2, einheit: "Stück", cat: "Milchprodukte" },
      { name: "Banane", menge: 1, einheit: "Stück", cat: "Obst & Gemuese" },
      { name: "Proteinpulver", menge: 30, einheit: "g", cat: "Vorrat" },
      { name: "Haferflocken", menge: 30, einheit: "g", cat: "Vorrat" },
    ],
    schritte: [
      "Banane zerdrücken, mit Eiern, Proteinpulver und Haferflocken zu einem Teig verrühren.",
      "Portionsweise in einer Pfanne bei mittlerer Hitze goldbraun backen.",
      "Nach Belieben mit etwas Obst servieren.",
    ],
  },
  {
    id: "gruener-smoothie",
    name: "Grüner Smoothie (vegan)",
    meal: "fruehstueck",
    tags: ["vegan", "vegetarisch", "glutenfrei", "laktosefrei"],
    zeit: 5,
    kcal: 280, protein: 7, kh: 46, fett: 8,
    zutaten: [
      { name: "Banane", menge: 1, einheit: "Stück", cat: "Obst & Gemuese" },
      { name: "Babyspinat", menge: 40, einheit: "g", cat: "Obst & Gemuese" },
      { name: "Apfel", menge: 1, einheit: "Stück", cat: "Obst & Gemuese" },
      { name: "Hafermilch", menge: 200, einheit: "ml", cat: "Milchprodukte" },
      { name: "Leinsamen", menge: 1, einheit: "EL", cat: "Vorrat" },
    ],
    schritte: [
      "Alle Zutaten in einen Mixer geben.",
      "Fein pürieren und sofort trinken.",
    ],
  },
  {
    id: "avocado-brot-ei",
    name: "Avocado-Brot mit pochiertem Ei",
    meal: "fruehstueck",
    tags: ["vegetarisch", "high-protein"],
    zeit: 12,
    kcal: 410, protein: 18, kh: 34, fett: 24,
    zutaten: [
      { name: "Vollkornbrot", menge: 2, einheit: "Scheibe", cat: "Backwaren" },
      { name: "Avocado", menge: 0.5, einheit: "Stück", cat: "Obst & Gemuese" },
      { name: "Eier", menge: 2, einheit: "Stück", cat: "Milchprodukte" },
      { name: "Zitronensaft", menge: 1, einheit: "TL", cat: "Obst & Gemuese" },
    ],
    schritte: [
      "Avocado mit Zitronensaft, Salz und Pfeffer zerdrücken und auf das Brot streichen.",
      "Eier in siedendem Wasser 3–4 Min pochieren.",
      "Eier auf das Avocado-Brot setzen.",
    ],
  },
  {
    id: "suesskartoffel-bowl",
    name: "Süßkartoffel-Bowl mit Kichererbsen (vegan)",
    meal: "mittag",
    tags: ["vegan", "vegetarisch", "glutenfrei", "laktosefrei", "high-protein"],
    zeit: 30,
    kcal: 540, protein: 18, kh: 78, fett: 16,
    zutaten: [
      { name: "Süßkartoffel", menge: 200, einheit: "g", cat: "Obst & Gemuese" },
      { name: "Kichererbsen (Dose)", menge: 120, einheit: "g", cat: "Vorrat" },
      { name: "Babyspinat", menge: 60, einheit: "g", cat: "Obst & Gemuese" },
      { name: "Tahini", menge: 1, einheit: "EL", cat: "Vorrat" },
      { name: "Olivenöl", menge: 1, einheit: "EL", cat: "Vorrat" },
    ],
    schritte: [
      "Süßkartoffel würfeln, mit Öl bei 200 °C ca. 25 Min backen.",
      "Kichererbsen mit Gewürzen mitrösten.",
      "Mit Spinat in einer Schale anrichten und mit Tahini beträufeln.",
    ],
  },
  {
    id: "haehnchen-gyros",
    ...
    tags: ["high-protein", "glutenfrei", "laktosefrei"],
    zeit: 25,
    kcal: 580, protein: 44, kh: 60, fett: 16,
    zutaten: [
      { name: "Hähnchenbrustfilet", menge: 150, einheit: "g", cat: "Fleisch & Fisch" },
      { name: "Reis", menge: 70, einheit: "g", cat: "Vorrat" },
      { name: "Zwiebel", menge: 0.5, einheit: "Stück", cat: "Obst & Gemuese" },
      { name: "Paprika", menge: 0.5, einheit: "Stück", cat: "Obst & Gemuese" },
      { name: "Gyrosgewürz", menge: 1, einheit: "EL", cat: "Vorrat" },
    ],
    schritte: [
      "Hähnchen in Streifen schneiden, mit Gyrosgewürz marinieren.",
      "Mit Zwiebel und Paprika kräftig anbraten.",
      "Reis kochen und zusammen servieren.",
    ],
  },
  {
    id: "caprese-salat",
    name: "Caprese-Salat mit Mozzarella",
    meal: "mittag",
    tags: ["vegetarisch", "low-carb", "glutenfrei"],
    zeit: 10,
    kcal: 380, protein: 20, kh: 10, fett: 28,
    zutaten: [
      { name: "Mozzarella", menge: 125, einheit: "g", cat: "Milchprodukte" },
      { name: "Tomate", menge: 2, einheit: "Stück", cat: "Obst & Gemuese" },
      { name: "Basilikum", menge: 5, einheit: "g", cat: "Obst & Gemuese" },
      { name: "Olivenöl", menge: 1, einheit: "EL", cat: "Vorrat" },
      { name: "Balsamico", menge: 1, einheit: "EL", cat: "Vorrat" },
    ],
    schritte: [
      "Mozzarella und Tomaten in Scheiben schneiden.",
      "Abwechselnd anrichten, mit Basilikum belegen.",
      "Mit Öl, Balsamico, Salz und Pfeffer beträufeln.",
    ],
  },
  {
    id: "lachs-spargel",
    name: "Ofen-Lachs mit grünem Spargel",
    meal: "abend",
    tags: ["pescetarisch", "low-carb", "high-protein", "glutenfrei", "laktosefrei"],
    zeit: 25,
    kcal: 420, protein: 36, kh: 8, fett: 26,
    zutaten: [
      { name: "Lachsfilet", menge: 150, einheit: "g", cat: "Fleisch & Fisch" },
      { name: "Grüner Spargel", menge: 200, einheit: "g", cat: "Obst & Gemuese" },
      { name: "Zitrone", menge: 0.5, einheit: "Stück", cat: "Obst & Gemuese" },
      { name: "Olivenöl", menge: 1, einheit: "EL", cat: "Vorrat" },
    ],
    schritte: [
      "Spargel und Lachs auf ein Blech legen, mit Öl, Salz und Pfeffer würzen.",
  ...
  {
    id: "linsenbolognese",
    name: "Vegane Linsenbolognese",
    meal: "abend",
    tags: ["vegan", "vegetarisch", "laktosefrei", "high-protein"],
    zeit: 30,
    kcal: 560, protein: 26, kh: 82, fett: 12,
    zutaten: [
      { name: "Rote Linsen", menge: 80, einheit: "g", cat: "Vorrat" },
      { name: "Passierte Tomaten", menge: 200, einheit: "g", cat: "Vorrat" },
      { name: "Vollkornspaghetti", menge: 90, einheit: "g", cat: "Vorrat" },
      { name: "Karotte", menge: 1, einheit: "Stück", cat: "Obst & Gemuese" },
      { name: "Zwiebel", menge: 0.5, einheit: "Stück", cat: "Obst & Gemuese" },
    ...
    schritte: [
      "Zwiebel und Karotte würfeln, andünsten.",
      "Linsen und Tomaten zugeben, mit 150 ml Wasser 15 Min köcheln.",
      "Spaghetti kochen und mit der Sauce servieren.",
    ],
  },
  {
    id: "blumenkohl-curry",
    name: "Blumenkohl-Curry (vegan)",
    meal: "abend",
    tags: ["vegan", "vegetarisch", "low-carb", "glutenfrei", "laktosefrei"],
    zeit: 28,
    kcal: 360, protein: 12, kh: 24, fett: 22,
    zutaten: [
      { name: "Blumenkohl", menge: 250, einheit: "g", cat: "Obst & Gemuese" },
      { name: "Kokosmilch", menge: 150, einheit: "ml", cat: "Vorrat" },
      { name: "Currypaste", menge: 1, einheit: "EL", cat: "Vorrat" },
      { name: "Zwiebel", menge: 0.5, einheit: "Stück", cat: "Obst & Gemuese" },
      { name: "Spinat", menge: 60, einheit: "g", cat: "Obst & Gemuese" },
    ],
    schritte: [
      "Zwiebel andünsten, Currypaste kurz mitrösten.",
      "Blumenkohlröschen und Kokosmilch zugeben, 15 Min köcheln.",
      "Spinat unterheben, bis er zusammenfällt.",
    ],
  },
  {
    id: "beeren-quark-snack",
    name: "Beeren-Quark-Snack",
    meal: "snack",
    tags: ["vegetarisch", "high-protein", "glutenfrei"],
    zeit: 4,
    kcal: 190, protein: 20, kh: 16, fett: 4,
    zutaten: [
      { name: "Magerquark", menge: 150, einheit: "g", cat: "Milchprodukte" },
      { name: "Gemischte Beeren", menge: 80, einheit: "g", cat: "Tiefkuehl" },
      { name: "Honig", menge: 1, einheit: "TL", cat: "Vorrat" },
    ],
    schritte: [
      "Quark mit Honig glattrühren.",
      "Mit Beeren toppen.",
    ],
  },
];
